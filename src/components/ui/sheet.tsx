...
/**
 * Sheet — side panel overlay backed by @radix-ui/react-dialog (ADR-0017).
 * Token-driven: card surface, border, foreground text. Slides in from
 * top/right/bottom/left. Shares the dialog primitive for consistent
 * overlay behavior.
 */
